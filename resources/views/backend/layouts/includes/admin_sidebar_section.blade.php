...
<div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside"
    ...
    <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand" kt-hidden-height="65" style="">
        <div class="kt-aside__brand-logo" style="margin-top:15px;"><!-- style="padding-bottom: 25px;padding-top: 35%;margin-left: 8%" -->
            <a style="text-decoration: none;" href="{{ url($url_prefix . '/dashboard') }}">
              <!-- <div style="font-size: 21px;color:#00f7f7a6;">{{$app_logo_head}}</div>
              <div style="font-size: 14px;color:#dc1212;font-weight: 400">{{$app_logo_sub}}</div> -->
            
               <img alt="{{ Config::get('app.site_title') }}"
                     src="{{ URL::asset('uploads/logos/cms-logo-png.png') }}" >
            </a>
        </div>
