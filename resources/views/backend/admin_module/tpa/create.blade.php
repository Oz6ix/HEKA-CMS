...
<div class="space-y-6">
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Add TPA</h1>
            <p class="mt-1 text-sm text-slate-500">Create a new TPA record.</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden max-w-2xl">
        {!! Form::open(['route'=>'tpa_add', 'id' => 'add_form', 'class' => 'kt-form', 'files' => true, 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
        <div class="p-6 space-y-5">
            <div>
                <label class="block text-sm font-medium text-slate-700 mb-1.5">TPA Name <span class="text-red-500">*</span></label>
                <input type="text" name="tpa" id="tpa" value="{{ old('tpa') }}" placeholder="Enter TPA Name" 
