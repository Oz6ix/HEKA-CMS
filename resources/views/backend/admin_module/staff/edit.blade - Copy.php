            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile"
                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    ...
                    <div class="kt-portlet__head-toolbar">
                        ...
                        <div class="btn-group">
                            <button type="button" class="btn btn-brand button-submit" id="update_button">
                ...
                <div class="kt-portlet__body">   
                       {!! Form::open(['id' => 'update_form','name' => 'update_form', 'class' => 'kt-form ', 'files' => true, 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}  
                                ...
                                <div class="kt-section__body">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-3">
                                        ...
                                        data-placement="left"
                                        title="Desktop Logo" data-html="true"
                                        data-content="<img class='popover-img' src='{{ URL::asset('public/uploads/staff/'. $item['staff_directory']. '/'.$item['staff_document']['0']['staff_image']) }}'
                                        alt='Desktop Logo' />">
                                        <span class="kt-userpic-logo">
                                        <img src="{{ URL::asset('public/uploads/staff/'. $item['staff_directory']. '/'.$item['staff_document']['0']['staff_image']) }}"
                                        alt="Desktop Logo"/>
                                        </span>
                                        </button>
                                        </div>
...
@section('scripts')
    ...
    <script src="{{ URL::asset('resources/assets/backend/js/validations/staff.js') }}"
