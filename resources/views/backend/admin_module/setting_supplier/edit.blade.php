...
<div class="space-y-6">
    <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <a href="{{ url($url_prefix . '/setting_supplier') }}"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden max-w-2xl">
        ...
        <div class="p-6 space-y-5">
            <div>
                ...
                <input type="text" name="suppliers" id="suppliers" value="{{ $item['suppliers'] }}" placeholder="Enter Supplier Name" 
        ...
        <div class="border-t border-slate-200 px-6 py-4 bg-slate-50 flex items-center justify-end gap-3">
            <a href="{{ url($url_prefix . '/setting_supplier') }}" class="rounded-lg border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-white transition-colors">Cancel</a>
