...
@section('title', 'Add Pharmacy Generic')
    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center justify-between mb-6 border-b border-gray-100 pb-4">
                <h2 class="text-xl font-bold text-gray-800">Add New Generic</h2>
            ...
            <form action="{{ route("pharmacy_generic.store") }}" method="POST" id="add_form" class="space-y-6" enctype="multipart/form-data">
                @csrf
