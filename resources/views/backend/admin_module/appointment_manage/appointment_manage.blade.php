                                                ...
                                                <div>
                                                    ...
                                                    <div class="kt-grid-nav kt-grid-nav--skin-light">
                                                        <div class="kt-grid-nav__row">
                                                            <a href="{{ url($url_prefix . '/symptom_type') }}" class="kt-grid-nav__item">
                                                                <span class="kt-grid-nav__icon">
                                                                    <svg xmlns="" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                            <polygon id="bound" points="0 0 24 0 24 24 0 24"/>
                                                                            <rect id="Rectangle-147" fill="#000000" opacity="0.3" x="14" y="4.69999981" width="3" height="3" rx="1.5"/>
                                                                            <path d="M6.82775054,15 C6.82139512,14.8644343 6.81818182,14.728047 6.81818182,14.5909091 C6.81818182,9.84628101 10.6644628,6 15.4090909,6 C18.9411859,6 21.9754239,8.13157886 23.2955957,11.1785272 C21.7651986,11.659899 21,12.6003899 21,14 C21,14 21.993332,14 23.979996,14 C23.9932599,14.1952513 24,14.3922931 24,14.5909091 C24,14.728047 23.9967867,14.8644343 23.9904313,15 L24,15 L24,16.5 C24,16.7761424 23.7761424,17 23.5,17 L1,17 C0.44771525,17 5.69110542e-14,16.5522847 5.68434189e-14,16 C5.67757835e-14,15.4477153 0.44771525,15 1,15 L6.82775054,15 Z" id="Combined-Shape" fill="#000000"/>
                                                                        </g>
                                                                    </svg> </span>
                                                                <span class="kt-grid-nav__title">Symptom Types</span>
                                                               <!--  <span class="kt-grid-nav__desc">eCommerce</span> -->
                                                            </a>
                                                            <a href="{{ url($url_prefix . '/casualty') }}" class="kt-grid-nav__item">
                                                                <span class="kt-grid-nav__icon">
                                                                ...
                                                                <span class="kt-grid-nav__title">Casualty</span>
                                                                <!-- <span class="kt-grid-nav__desc">Console</span> -->
                                                            </a>
                                                        </div>
                                                        <div class="kt-grid-nav__row">
                                                            <a href="{{ url($url_prefix . '/tpa') }}" class="kt-grid-nav__item">
                                                                <span class="kt-grid-nav__icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                            <rect id="bound" x="0" y="0" width="24" height="24"></rect>
                                                                ...
                                                                <span class="kt-grid-nav__title">TPA</span>
                                                                <!-- <span class="kt-grid-nav__desc">Pending Tasks</span> -->
                                                            </a>
                                                            <a href="{{ url($url_prefix . '/frequency') }}" class="kt-grid-nav__item">
                                                                <span class="kt-grid-nav__icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                ...
                                                                <span class="kt-grid-nav__title">Frequency</span>
                                                            </a>
                                                        </div>
                                                        <div class="kt-grid-nav__row">
                                                            <a href="{{ url($url_prefix . '/center') }}" class="kt-grid-nav__item">
                                                                <span class="kt-grid-nav__icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                            <rect id="bound" x="0" y="0" width="24" height="24"></rect>
                                                                ...
                                                                <span class="kt-grid-nav__title">Centers</span>
                                                                <!-- <span class="kt-grid-nav__desc">Pending Tasks</span> -->
                                                            </a>
                                                            <!-- <a href="{{ url($url_prefix . '/frequency') }}" class="kt-grid-nav__item">
                                                                <span class="kt-grid-nav__icon">
