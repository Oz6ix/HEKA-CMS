                                                ...
                                                <div>
                                                    ...
                                                    <div class="kt-grid-nav kt-grid-nav--skin-light">
                                                        <div class="kt-grid-nav__row">
                                                            <a href="{{ url($url_prefix . '/staff_roles') }}" class="kt-grid-nav__item">
                                                                ...
                                                                <span class="kt-grid-nav__title">Staff Role</span>
                                                               <!--  <span class="kt-grid-nav__desc">eCommerce</span> -->
                                                            </a>
                                                            <a href="{{ url($url_prefix . '/staff_departments') }}" class="kt-grid-nav__item">
                                                                <span class="kt-grid-nav__icon">
                                                                ...
                                                                <span class="kt-grid-nav__title">Staff Department</span>
                                                                <!-- <span class="kt-grid-nav__desc">Console</span> -->
                                                            </a>
                                                        </div>
                                                        <div class="kt-grid-nav__row">
                                                            <a href="{{ url($url_prefix . '/staff_designations') }}" class="kt-grid-nav__item">
                                                                <span class="kt-grid-nav__icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                            <rect id="bound" x="0" y="0" width="24" height="24"></rect>
                                                                ...
                                                                <span class="kt-grid-nav__title">Staff Designation</span>
                                                                <!-- <span class="kt-grid-nav__desc">Pending Tasks</span> -->
                                                            </a>
                                                            <a href="{{ url($url_prefix . '/staff_specialists') }}" class="kt-grid-nav__item">
                                                                <span class="kt-grid-nav__icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                ...
                                                                <span class="kt-grid-nav__title">Staff Specialist</span>
