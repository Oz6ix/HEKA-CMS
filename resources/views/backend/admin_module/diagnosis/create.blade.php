        ...
        <div class="col-lg-12">
            ...
            <div class="bg-white shadow-sm ring-1 ring-slate-900/5 rounded-xl overflow-hidden">
                <div class="bg-white shadow-sm ring-1 ring-slate-900/5 rounded-xl overflow-hidden">
                    ...
                    <div class="bg-white shadow-sm ring-1 ring-slate-900/5 rounded-xl overflow-hidden">
                        <a href="{{ url($url_prefix . '/diagnosis/list/'.$id) }}" class="inline-flex items-center rounded-md bg-slate-100 px-3 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-200">
                            ...
                            <div>
                                <div>
                                    ...
                                    <div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4">
                                        ...
                                        <input type="datetime-local" name="checkup_at" id="event_datetime" class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" value="{{ $previousDiagnosis->checkup_at }}" required>
                                        </div>
                                      </div> 
                                    <div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4">
                                        ...
                                        <div class="col-5">
                                            <input type="text" class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="height" id="height" 
                                                   placeholder="Enter height" value="{{$previousDiagnosis->height}}"/>
                                        ...
                                        <select class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="height_unit" id="height_unit">
                                            ...
                                            <option value="{{ $key }}" {{ ($key == $item_basic[0]['height_unit']) ? 'selected' : '' }} >{{ $value }}</option>
                                            @endforeach 
                                        </select> 
                                        </div>
                                      </div> 
                                      ...
                                      <div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4">
                                        ...
                                        <div class="col-5">
                                            <input type="text" class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="weight" id="weight"
                                                   placeholder="Enter weight" value="{{$previousDiagnosis->weight}}"/>
                                        </div>
                                        <div class="col-4">
                                        <select class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="weight_unit" id="weight_unit">
                                            ...
                                            <option value="{{ $key }}" {{ ($key == $item_basic[0]['weight_unit']) ? 'selected' : '' }} >{{ $value }}</option>
                                            @endforeach 
                                        </select> 
                                        </div>
                                      </div> 
                                      ...
                                      <div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4">
                                        ...
                                        <div class="col-4">
                                            <input type="text" class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="systolic_bp" id="systolic_bp"
                                                   placeholder="Systolic value " value="{{$previousDiagnosis->systolic_bp}}"/>
                                        </div>
                                        <div class="col-4">
                                            <input type="text" class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="diastolic_bp" id="diastolic_bp"
                                                   placeholder="Diastolic value" value="{{$previousDiagnosis->diastolic_bp}}"/>
                                        </div>
                                        <div class="col-1"></div>
                                      </div> 
                                      ...
                                      <div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4">
                                        ...
                                        <div class="sm:col-span-3">
                                            <input type="text" class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="pulse" id="pulse"
                                                   placeholder="Enter pulse" value="{{$previousDiagnosis->pulse}}"/>
                                        </div>
                                      </div> 
                                      ...
                                      <div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4">
                                        ...
                                        <div class="col-5">
                                            <input type="text" class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="temperature" id="temperature"
                                                   placeholder="Enter temperature" value="{{$previousDiagnosis->temperature}}"/>
                                        </div>
                                        <div class="col-4">
                                        <select class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="temperature_unit" id="temperature_unit">
                                            ...
                                            <option value="{{ $key }}" {{ ($key == $item_basic[0]['temperature_unit']) ? 'selected' : '' }} >{{ $value }}</option>
                                            @endforeach 
                                        </select> 
                                        </div>
                                      </div>
                                      <div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4">
                                        ...
                                        <div class="sm:col-span-3">
                                            ...
                                            placeholder="Enter SPO2" value="{{$previousDiagnosis->rbs}}"/>
                                        </div>
                                      </div> 
                                      <div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4">
                                        ...
                                        <div class="sm:col-span-3">
                                            <input type="text" class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="respiration" id="respiration"
                                                   placeholder="Enter respiration" value="{{$previousDiagnosis['respiration']}}"/>
                                        </div>
                                      </div> 
                                      ...
                                      <div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4">
                                        ...
                                        <div class="sm:col-span-3">
                                            <input type="text" class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="rbs" id="rbs" placeholder="Enter RBS" value="{{$previousDiagnosis->rbs}}"/>
                                        </div>
                                      </div> 
                                        ...
                                        <div class="sm:col-span-3">
                                            <select name="symptom_type_id" id="symptom_type" class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm">
                                                ...
                                                @foreach($symptom_item as $symptom_type)
                                                    ...
                                                    <?php if($previousDiagnosis->symptom_type != null) { ?>
                                                        @if($previousDiagnosis->symptom_type->id == $symptom_type->id)
                                                            selected
                                                        @endif
                                                    <?php } ?>   
                                    ...
                                    <div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4">
                                        ...
                                        <div class="sm:col-span-3">
                                            <input type="text" class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="symptom" id="symptom"
                                                   placeholder="Enter symptom" value="{{ $previousDiagnosis->symptom }}"/>
                                        </div>
                                      </div> 
                                      ...
                                      <div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4">
                                        ...
                                        <div class="sm:col-span-3">
                                          <textarea class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="description" id="description" rows="5" spellcheck="false" placeholder="Enter description">{{ $previousDiagnosis->description }}</textarea>
                                        </div>
                                      </div> 
                                      ...
                                      <div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4">
                                        ...
                                        <div class="sm:col-span-3">
                                          <textarea class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="note" id="note" rows="5" spellcheck="false" placeholder="Enter note">{{ $previousDiagnosis->note }}</textarea>
                                ...
                                <div>
                                    ...
                                    <div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4">
                                      ...
                                      <!-- <div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4">
                                        ...
                                        <div class="sm:col-span-3">
                                        <label class="switch">
                                            <input type="checkbox" id="togBtn" checked="checked" value="on" name="icd_diagnosis">
                                      ...
                                      <div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4">
                                        ...
                                        <div class="sm:col-span-3">
                                            ...
                                            <input type="hidden" name="treatment_and_intervention_id" id="treatment_and_intervention_id"
                                                   value="{{ old('treatment_and_intervention_id') }}"/>
                                        </div>
                                    </div> 
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="kt-form__group--inline">
                                                            ...
                                                            <div class="kt-form__control">
                                                                <input type="text" class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="pharmacy_name" onkeyup="CallFunctionReset(this)" onfocusout="CallFunction(this)"  list="medicine" placeholder="Enter drug name">
                                                ...
                                                <div data-repeater-item class="form-group row align-items-center">
                                                    <div class="col-md-4">
                                                        <div class="kt-form__group--inline">
                                                            ...
                                                            <div class="kt-form__control">
                                                                <!-- <input type="text" class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="item" placeholder="Enter item"> -->
                                            ...
                                            <div data-repeater-item class="form-group row align-items-center">
                                                <div class="col-md-5">
                                                    <div class="kt-form__group--inline">
                                                        ...
                                                        <div class="kt-form__control">
                                                            <!-- <input type="text" class="block w-full rounded-md border-0 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm" name="test_name" id="test_name" placeholder="Enter test name"> -->
...
//alert(document.getElementsByName('prescription[0][drug_name]').length);
if(document.getElementsByName('prescription[0][pharmacy_name]').length>0){
var datap= $('#kt_repeater_1').repeaterVal();
if((datap.prescription).length>0){
for(i=0;i<(datap.prescription).length;i++){
    if(datap['prescription'][i]['pharmacy_name']!=""||datap['prescription'][i]['quantity']!=""||datap['prescription'][i]['unit_id']!=null||datap['prescription'][i]['frequency_id']!=null||datap['prescription'][i]['no_of_days']!=""){
        //alert(JSON.stringify((datap.prescription).length));
                ...
                var prescriptions = $('select[name^="prescription"]');
                    ...
                    prescription.filter('input[name$="[pharmacy_name]"]').each(function() {
                        $(this).rules("add", {
                            required: true,
                            messages: {
...
<!--begin::Page Scripts(used by this page) -->  
    ...
    <script src="{{ URL::asset('assets/js/demo1/pages/crud/forms/widgets/bootstrap-select.js') }}" type="text/javascript"></script> 
