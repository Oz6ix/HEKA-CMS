...
{
    protected $table = 'hospital_settings_radiology_parameters';
    protected $primaryKey = 'id';
    protected $fillable = ['radiology_id', 'parameter_name', 'range', 'unit', 'status', 'delete_status'];
    public static $rules = [
    ...
    public function radiology(){
        ...
        return $this->belongsTo('App\Models\Radiology', 'radiology_id');
